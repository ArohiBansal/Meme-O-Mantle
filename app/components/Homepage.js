  ...
  return (
    <>
      <div className="h-full w-full  ">
        ...
        <div className='font-semibold text-6xl text-white'>Meme-o-Mantle</div>
            <div className='text-blue-600'>EARLY ACCESS</div>
            <div className='text-green-500'>Start Minting Or Trading In Seconds</div>
